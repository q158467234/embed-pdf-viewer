...
export const functions = {
  ...
  EPDFAnnot_GetFormFieldRawValue: [["number","number","number","number"] as const, 'number'] as const,
  ...
  EPDFAnnot_SetFormFieldOptions: [["number","number","number","number"] as const, 'boolean'] as const,
